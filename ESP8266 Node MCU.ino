...
char myssid[] = "PLDTHOMEDSL35070";         // your network SSID (name)
char mypass[] = "555Timer";          // your network password


//Credentials for Google GeoLocation API...
const char* Host = "www.googleapis.com";
String thisPage = "/geolocation/v1/geolocate?key=";
String key = "AIzaSyASvbEoqEphjmHbtf4dy41haX8jMhHVzyA";
...
void loop() {
  ...
  swSer.print(latitude, 6);
  swSer.print(",");
  swSer.print(longitude, 6);
  swSer.print("#");
}
